...
HD_PWD='/home/shebalin/work/q-pix/qpix-digital/prototype-project/QpixProto-Minized/QpixProto.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log QpixProtoTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source QpixProtoTop.tcl
