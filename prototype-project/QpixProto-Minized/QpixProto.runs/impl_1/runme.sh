...
HD_PWD='/home/shebalin/work/q-pix/qpix-digital/prototype-project/QpixProto-Minized/QpixProto.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log QpixProtoTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source QpixProtoTop.tcl -notrace
